...
from .assessment import assessment_bp  # NOVO: Blueprint de avaliações
...
def register_blueprints(app, url_prefix='/api'):
    ...
    app.register_blueprint(assessment_bp, url_prefix=url_prefix)  # NOVO
    ...
    print(f"   - Assessment Blueprint ({url_prefix}) [NOTAS BIMESTRAIS]")
